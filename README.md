...
```
docker run --init --rm --net=host chalmersrevere/opendlv-device-gps-pos-multi:v0.0.2 opendlv-device-gps-pos --pos_ip=192.168.1.77 --pos_port=5602 --cid=111 --verbose
```
